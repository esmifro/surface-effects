...
Proof.
  ...
  - destruct (AsciiVars.eq_dec x r0).
    + inversion e. destruct (AsciiVars.eq_dec r0 r0); simpl.
      * rewrite NPeano.Nat.eqb_refl. reflexivity.
...
Proof.
  intros x t u H. unfold open, close_var. generalize 0.
  ...
  - f_equal;[ | apply IHt]. unfold subst_rgn, opening_rgn_in_rgn2, closing_rgn_in_rgn2.
    ...
    + now inversion H.
  - f_equal;[apply IHt1 | | apply IHt2 | | apply IHt3]; inversion H; subst; auto.
    + now apply subst_as_close_open_eps.     
    + now apply subst_as_close_open_eps.
  - f_equal;[ | apply IHt]; inversion H; subst; auto.
    + now apply subst_as_close_open_eps.
Qed.
...
Proof. 
  ...
  - destruct (AsciiVars.eq_dec r x).
    + rewrite NPeano.Nat.eqb_refl. inversion e; now subst.
    + reflexivity.
Qed.      
